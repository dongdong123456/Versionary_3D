...
class Ui_Show(object):
    def setupUi(self, Form):
        ...
        self.widget.setGeometry(QtCore.QRect(190, 20, 642, 712))
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_3.setText(_translate("Form", "单次触发"))
        self.pushButton_2.setText(_translate("Form", "选择模型"))
